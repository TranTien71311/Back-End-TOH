...
namespace SpeedTOHAPI.Controllers
{
    ...
    public class POSSysInfoController : ApiController
    {
        [HttpGet]
        public APIResult Get()
        {
            ...
            try
            {
                ...
                DataTable Data = new DataTable("POSSysInfo");
                Data.Load(command.ExecuteReader());
                List<POSSysInfoModel> SysInfo = JsonConvert.DeserializeObject<List<POSSysInfoModel>>(JsonConvert.SerializeObject(Data));
